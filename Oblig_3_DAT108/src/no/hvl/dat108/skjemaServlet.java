...
public class skjemaServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		Skjema skjema = new Skjema(request); // kunnne vært en egen metode, men denne sjekker om mobilnummeret allerede 
		boolean unikNr = true;				// eksisterer i databasen, og gjør så det unikNr blir false om det fins fra før
		if(skjema.allegyldig()) {			// som igjen gjør at det ikke blir mulig å legge det til i databasen og buker får opp en feilmelding
