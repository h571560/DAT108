...
public class logginnServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (loginOk) {
			...
			request.getSession().removeAttribute("loginFeil");
			request.getSession().removeAttribute("passord");
			request.getSession().setAttribute("mobilnr",mobil);
